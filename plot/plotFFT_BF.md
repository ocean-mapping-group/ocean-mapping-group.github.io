...
## Output
*   A PostScript metafile (`plot.meta` or specified by `-outfile`) visualizing the linear array, incoming wavelets (optional), amplitude time series, and the FFT-derived beam pattern.
```
```
```
---
