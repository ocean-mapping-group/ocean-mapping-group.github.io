...
1.  **Initialization:** Parses command-line arguments to set input/output filenames, plot size, X/Y ranges, and titles.
...
## Output
*   A PostScript metafile (`plot.meta` or specified by `-outfile`) visualizing the ray trace solutions.
```
```
---
layout: default
