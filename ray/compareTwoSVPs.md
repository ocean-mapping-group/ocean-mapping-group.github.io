...
| `-surf_SV_shift <val>` | Applies a surface sound velocity shift (m/s) to the assumed sound speed for ingoing beam steering. |
...
## Output
*   An ASCII file (`-out`) containing multiple columns of across-track positions and depths, representing the ray path predictions for the reference and comparison SVPs/shifts.
```
```
---
layout: default
